...
class U_net:
    def __init__(self, train_loader, eval_loader, test_loader):
        self.device = 'cuda' if torch.cuda.is_available() else 'cpu'
        self.train_loader = train_loader # 학습 데이터
        self.eval_loader = eval_loader # 평가 데이터
        self.test_loader = test_loader # 테스트 데이터
